...
{$I runtime/sdlplatform.inc}             // 2.0.14 (completed)
{$I runtime/sdlpower.inc}                // 2.0.14 (completed)
{$I runtime/sdlthread.inc}               // 2.30.2
{$I runtime/sdlatomic.inc}               // 2.0.20
{$I runtime/sdlmutex.inc}                // 2.26.5
{$I runtime/sdltimer.inc}                // 2.0.18
{$I runtime/sdlpixels.inc}               // 2.26.5 (completed)
{$I runtime/sdlrect.inc}                 // 2.24.0 (completed)
{$I runtime/sdlrwops.inc}                // 2.0.14
{$I runtime/sdlaudio.inc}                // 2.26.3
{$I runtime/sdlblendmode.inc}            // 2.0.14 (completed)
{$I runtime/sdlsurface.inc}              // 2.0.14
{$I runtime/sdlvideo.inc}                // 2.28.0
{$I runtime/sdlshape.inc}                // 2.24.0 (completed)
{$I runtime/sdlhints.inc}                // 2.26.0 (completed)
{$I runtime/sdlloadso.inc}               // 2.24.1
{$I runtime/sdlmessagebox.inc}           // 2.0.14 (completed)
{$I runtime/sdlrenderer.inc}             // 2.0.22
{$I runtime/sdlscancode.inc}             // 2.26.2 (completed)
{$I runtime/sdlkeycode.inc}              // 2.26.2 (completed)
{$I runtime/sdlkeyboard.inc}             // 2.24.1
{$I runtime/sdlmouse.inc}                // 2.0.24
{$I runtime/sdlguid.inc}                 // 2.24.0 (completed)
{$I runtime/sdljoystick.inc}             // 2.24.0 (completed)
...
{$I runtime/sdltouch.inc}                // 2.24.0 (completed)
{$I runtime/sdlgesture.inc}              // 2.26.2 (completed)
{$I runtime/sdlsyswm.inc}                // 2.26.5 (completed)
{$I runtime/sdlevents.inc}               // 2.24.0
{$I runtime/sdllocale.inc}               // 2.0.14
{$I runtime/sdlclipboard.inc}            // 2.24.1 (completed)
{$I runtime/sdlcpuinfo.inc}              // 2.0.14
{$I runtime/sdlfilesystem.inc}           // 2.24.1 (completed)
{$I runtime/sdllog.inc}                  // 2.0.14
{$I runtime/sdlmisc.inc}                 // 2.0.14
{$I runtime/sdlsystem.inc}               // 2.24.0
{$I runtime/sdl.inc}                     // 2.0.14 (completed)
